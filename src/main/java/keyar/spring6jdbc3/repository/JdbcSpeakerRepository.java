package keyar.spring6jdbc3.repository;

import keyar.spring6jdbc3.model.Speaker;
import keyar.spring6jdbc3.repository.util.SpeakerRowMapper;
...
@Repository
public class JdbcSpeakerRepository implements SpeakerRepository {

    private JdbcTemplate jdbcTemplate;

    public JdbcSpeakerRepository(JdbcTemplate jdbcTemplate) {
